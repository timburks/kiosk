...
func init() {
	...
	SetSignIdForKioskIdsCmd.Flags().Int32SliceVar(&SetSignIdForKioskIdsInput.KioskIds, "kiosk_ids", []int32{}, "Required.")

	SetSignIdForKioskIdsCmd.Flags().Int32Var(&SetSignIdForKioskIdsInput.SignId, "sign_id", 0, "Required.")
